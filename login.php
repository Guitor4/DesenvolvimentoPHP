                ...
                <div class="card-header bg-primary border">Validação de login</div>
                    <div class="card-body border">
                        <form method="POST" action="">
                            ...
                            <div class="row">
                                <div class="col-md-8 offset-md-2 ">
                                    <input class="form-control" name="senha"></input>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-8 offset-md-2 col-xl-12" style="margin-top: 15px;">
                                    <input class="btn btn-success" type = "submit" name = "enviar" value = "Enviar"></input>
                                    <input class="btn btn-danger" type = "submit" name = "cancelar" value = "Cancelar"></input>
                                </div>
                            </div>
                        </form>
